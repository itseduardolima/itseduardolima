...
Meu nome é Eduardo Lima, tenho 22 anos. Sou um desenvolvedor de software apaixonado pela tecnologia. Atualmente trabalho como Desenvolvedor Back-end como estagiário no Instituto Conecthus - Tecnologia e Biotecnologia do Amazonas .
...
Meu desenvolvimento com Back-end começou quando recebi a missão de fazer parte da equipe de software como estagiário no Instituto Conecthus, onde comecei a desenvolver no Back-end usando o Node e o Nestjs como Framework para a criação de API's.
